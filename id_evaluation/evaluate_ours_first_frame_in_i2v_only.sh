...
torchrun --nproc_per_node $WORLD_SIZE --standalone evaluate.py \
    --output_path /root/daneul/projects/refactored/CogVideo/id_evaluation/ours_first_frame_in_i2v_only_output\
    --video_dir /root/daneul/projects/refactored/CogVideo/id_evaluation/ours_first_frame_in_i2v_only \
    --image_dir /root/daneul/projects/refactored/CogVideo/id_evaluation/processed_white_720x480 \
    --json_path /root/daneul/projects/refactored/CogVideo/id_evaluation/ours_first_frame_in_i2v_only_vid_to_img.json \
