...
torchrun --nproc_per_node $WORLD_SIZE --standalone evaluate.py \
    ...
    --video_dir /mnt/carpedkm_data/result250304/original_vid_ratio_0.2_video_count_1k/seed_42 \
    ...
    --prompt_json /root/daneul/projects/refactored/CogVideo/id_evaluation/ours_1k_vid_to_prompt.json \
    --mode 'default' \
    --n_frames 16
