...
def compute_dynamic_degree(video_list, device, submodules_list, **kwargs):
    ...
    if isinstance(video_list, dict):
        video_list = list(video_list.keys())
    video_dir = kwargs.get('video_dir', '')
    video_list = [os.path.join(video_dir, v) for v in video_list]
