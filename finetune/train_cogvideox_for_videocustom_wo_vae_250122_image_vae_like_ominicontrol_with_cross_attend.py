...
class ImageDataset(Dataset):
    def __init__(
        ...
        self.height = height
        self.width = width
        self.val_instance_prompt_dict = {'oranges_omini':"A close up view of the dish with orange. It is placed on a wooden table. The background is a dark room, the TV is on, and the screen is showing a cooking show. ", 
                                         'clock_omini':"In a Bauhaus style room, the yellow clock is placed on a shiny glass table, with a vase of flowers next to it. In the afternoon sun, the shadows of the blinds are cast on the wall.",
                                         'rc_car_omini': "A film style shot. On the moon, this rc car goes across the moon surface. The background is that Earth looms large in the foreground.",
                                         'shirt_omini': "On the beach, a lady sits under a beach umbrella with 'Omini' written on it. She's wearing this green hawaian shirt and has a big smile on her face, with her surfboard hehind her. The sun is setting in the background. The sky is a beautiful shade of orange and purple.",
