    ...
    def save_model_hook(models, weights, output_dir):
        if accelerator.is_main_process:
            ...
            for model in models:
                ...
                # Check for CLIPVisionModelWithLoRA
                elif isinstance(unwrapped_model, CLIPVisionModelWithLoRA):
                    vision_model_lora_layers_to_save = get_peft_model_state_dict(model)
