...
accelerate launch --config_file accelerate_config_machine_single_4gpu.yaml --multi_gpu \
  ...
  --report_to wandb \
  --inference \
  --resume_from_checkpoint /mnt/carpedkm_data/result250109/fixed_dataloader_result_check_200k_512x512_embedding_refined_prompt_without_subject_moviegenstyle/checkpoint-2950
