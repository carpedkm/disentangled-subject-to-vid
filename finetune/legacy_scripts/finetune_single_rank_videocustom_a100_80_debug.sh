...
export OUTPUT_PATH="/mnt/carpedkm_data/finetune_result/finetune_debug2"
export VALIDATION_REF_PATH="./val_sample_debug/"
...
accelerate launch --config_file accelerate_config_machine_single.yaml --multi_gpu \
  train_cogvideox_for_videocustom_inf_fix2.py \
