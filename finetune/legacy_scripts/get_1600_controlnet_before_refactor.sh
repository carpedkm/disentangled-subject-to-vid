...
export ANNO_PATH="/root/daneul/projects/refactored/CogVideo/annotation/video_dict_foreground_subset4000.json"
export OUTPUT_PATH="/mnt/carpedkm_data/finetune_result/241203/finetune1600_zero_conv_controlnet_w_inference_fix_wo_t5_proj_wo_bg_cross_pairs/checkpoint-15200"
...
accelerate launch --config_file accelerate_config_machine_single_4gpu.yaml --multi_gpu \
  ...
  --wo_bg \
  --report_to wandb \
  --resume_from_checkpoint /mnt/carpedkm_data/finetune_result/241203/finetune1600_concat_padded_wo_bg_cross_pairs/checkpoint-15200
  # --resume_from_checkpoint /mnt/carpedkm_data/finetune_result/241119/finetune4000_concat_padded/checkpoint-100
