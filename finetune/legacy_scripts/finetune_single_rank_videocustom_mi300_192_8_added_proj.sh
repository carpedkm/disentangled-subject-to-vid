...
export OUTPUT_PATH="/mnt/carpedkm_data/finetune_result/finetune4000_one_init_with_PE_4000subset_T5_zero_init_added_proj_lin"
...
accelerate launch --config_file accelerate_config_machine_single_8gpu.yaml --multi_gpu \
  train_cogvideox_for_videocustom_inf_fix_add_proj_lin.py \
