...
export OUTPUT_PATH="/mnt/carpedkm_data/result250109/result_check_100k_512x512_embedding_refined_prompt_without_subject_moviegenstyle_vaeadd"
...
accelerate launch --config_file accelerate_config_machine_single.yaml \
  ...
  --report_to wandb \
  --inference \
  --resume_from_checkpoint /mnt/carpedkm_data/result250109/result_check_100k_512x512_embedding_refined_prompt_without_subject_moviegenstyle_vaeadd/checkpoint-250
