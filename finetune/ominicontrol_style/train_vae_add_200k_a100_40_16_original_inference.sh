...
export OUTPUT_PATH="/mnt/carpedkm_data/result250115/512x512embedding_refined_oministyle_vaeadd_original"
...
accelerate launch --config_file ../accelerate_config_machine_single_4gpu.yaml --multi_gpu \
  ...
  --seen_validation \
  --inference \
  --resume_from_checkpoint /mnt/carpedkm_data/result250115/512x512embedding_refined_oministyle_vaeadd_original/checkpoint-4950
  # --subset_cnt 200000 \
  # --inference \
