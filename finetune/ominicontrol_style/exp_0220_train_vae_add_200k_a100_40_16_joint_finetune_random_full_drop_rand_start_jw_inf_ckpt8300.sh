...
export OUTPUT_PATH="/mnt/carpedkm_data/result250220/joint_finetune_randomdrop_full_start_random_in_i2v_part_40_16"
...
accelerate launch --config_file ../accelerate_config_machine_single_inf.yaml \
  ...
  --video_ref_root /mnt/carpedkm_data/daneul/image_gen_ds/second_stage_video_train_pexels_rand/second_stage_video_train_pexels_rand \
  --load_to_ram \
  --latent_data_root /mnt/carpedkm_data/pexels_4k_updatd_vae_latents\
  --report_to wandb \
  --inference \
  --resume_from_checkpoint checkpoint-8300
  # --inference 채
