...
export OUTPUT_PATH="/mnt/carpedkm_data/result250218/joint_train_40_32_prob02_last"
...
accelerate launch --config_file ../accelerate_config_machine_single.yaml --multi_gpu \
  ...
  --video_ref_root /mnt/carpedkm_data/image_gen_ds/second_stage_video_train_pexels_last \
  --load_to_ram \
