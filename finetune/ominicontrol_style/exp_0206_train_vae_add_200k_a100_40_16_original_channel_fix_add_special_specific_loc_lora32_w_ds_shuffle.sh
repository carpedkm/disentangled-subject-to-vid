...
export OUTPUT_PATH="/mnt/carpedkm_data/result250206/720x480embedding_refined_oministyle_vaeadd_original_channel_fix_pos_embed_add_special_tk_modified_special_loc_lora32_prodigy_w_ds_shuffle"
...
accelerate launch --config_file ../accelerate_config_machine_multi_16nodes.yaml --multi_gpu --machine_rank ${NODE_RANK} \
