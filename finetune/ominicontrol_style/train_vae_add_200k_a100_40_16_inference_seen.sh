...
export OUTPUT_PATH="/mnt/carpedkm_data/result25012/512x512embedding_refined_oministyle_vaeadd"
...
accelerate launch --config_file ../accelerate_config_machine_single_4gpu.yaml --multi_gpu \
  ...
  --subset_cnt 200000 \
  --inference \
  --resume_from_checkpoint /mnt/carpedkm_data/result25012/512x512embedding_refined_oministyle_vaeadd/checkpoint-7000 \
  --seen_validation
