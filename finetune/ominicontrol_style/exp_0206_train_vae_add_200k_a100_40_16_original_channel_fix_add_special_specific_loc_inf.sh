...
export OUTPUT_PATH="/mnt/carpedkm_data/result250206/720x480embedding_refined_oministyle_vaeadd_original_channel_fix_pos_embed_add_special_tk_modified_special_loc"
...
accelerate launch --config_file ../accelerate_config_machine_single.yaml --multi_gpu  \
  ...
  --report_to wandb \
  --inference \
  --resume_from_checkpoint checkpoint-3700
