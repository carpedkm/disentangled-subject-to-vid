...
export OUTPUT_PATH="/mnt/carpedkm_data/result250211/720x480embedding_qformer"
...
accelerate launch --config_file ../accelerate_config_machine_multi_3nodes.yaml --multi_gpu  --machine_rank $1 \
  ../train_0210_layer_replacement_with_edit.py\
