...
export OUTPUT_PATH="/mnt/carpedkm_data/result250215/special_tk_layernorm_fix_pos_embed_fix_40_32_second_stage"
...
accelerate launch --config_file ../accelerate_config_machine_multi_8nodes.yaml --multi_gpu --machine_rank ${NODE_RANK} \
