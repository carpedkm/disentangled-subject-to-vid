...
export ANNO_PATH="/mnt/carpedkm_data/image_gen_ds/omini200k_720p_full/metadata_omini200k_update_refined_add_split.json"
# export OUTPUT_PATH="/mnt/carpedkm_data/finetune_result/241223/compare_controlnet_5b_w_latent_4000_xpairs_wobg_single_frame"
export OUTPUT_PATH="/mnt/carpedkm_data/result250206/720x480embedding_refined_oministyle_vaeadd_original_channel_fix_pos_embed_add_special_tk_more_data"
...
accelerate launch --config_file ../accelerate_config_machine_single_4gpu.yaml --multi_gpu  \
  ../train_cogvideox_for_videocustom_wo_vae_250206_image_vae_like_ominicontrol_with_cross_attend_token_mod_more_data.py \
