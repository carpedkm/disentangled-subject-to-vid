...
export OUTPUT_PATH="/mnt/carpedkm_data/result250127/720x480embedding_refined_oministyle_vaeadd_original_channel_fix_200k_cross_attend_vision_and_text_add_special_tk"
