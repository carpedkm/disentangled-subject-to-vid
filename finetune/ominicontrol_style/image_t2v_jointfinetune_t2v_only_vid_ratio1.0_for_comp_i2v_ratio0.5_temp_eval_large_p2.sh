...
export OUTPUT_PATH="/mnt/carpedkm_data/arxiv_ready_250420/t2v_pexels_finetune"
...
export TEMPORAL_EVAL_SAVE_DIR="/mnt/carpedkm_data/temporal_eval_result/vid_finetune_orig_comp_ckpt1000_fix_0420_i2v"
