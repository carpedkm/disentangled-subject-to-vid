...
export OUTPUT_PATH="/mnt/carpedkm_data/result250115/512x512embedding_refined_oministyle_vaeadd_original_wo_ds_shuffle_w_pos_embed"
...
accelerate launch --config_file ../accelerate_config_machine_single_4gpu.yaml --multi_gpu \
  ...
  --pos_embed \
  --inference \
  --resume_from_checkpoint /mnt/carpedkm_data/result250115/512x512embedding_refined_oministyle_vaeadd_original_wo_ds_shuffle_w_pos_embed/checkpoint-1450 \
  # --seen_validation
  # --subset_cnt 200000 \
  # --inference \
