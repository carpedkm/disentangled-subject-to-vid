...
export OUTPUT_PATH="/mnt/carpedkm_data/result250208/720x480embedding_refined_oministyle_vaeadd_original_channel_fix_pos_embed_add_special_tk_as_reg_with_input_noise_fix"
