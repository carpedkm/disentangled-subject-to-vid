...
export OUTPUT_PATH="/mnt/carpedkm_data/result250121/720x480embedding_refined_oministyle_vaeadd_original_channel_fix_20k_13frames"
...
accelerate launch --config_file ../accelerate_config_machine_single_4gpu.yaml --multi_gpu \
  ../train_cogvideox_for_videocustom_wo_vae_250106_image_vae_like_ominicontrol_still_vid.py \
  ...
  --subset_cnt 20000 \
  --inference \
  --resume_from_checkpoint /mnt/carpedkm_data/result250121/720x480embedding_refined_oministyle_vaeadd_original_channel_fix_20k_13frames/checkpoint-1500
  # --inference \
