...
export OUTPUT_PATH="/mnt/carpedkm_data/result250114/512x512embedding_refined_oministyle_vaeadd_w_posembed_wo_pos_delta_50k_fix_w_embed_lora"
...
accelerate launch --config_file ../accelerate_config_machine_single_4gpu.yaml --multi_gpu \
  ...
  --seen_validation \
  --inference \
  --resume_from_checkpoint /mnt/carpedkm_data/result250114/512x512embedding_refined_oministyle_vaeadd_w_posembed_wo_pos_delta_50k_fix_w_embed_lora/checkpoint-1200
