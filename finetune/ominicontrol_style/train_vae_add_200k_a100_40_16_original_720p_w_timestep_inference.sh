...
export OUTPUT_PATH="/mnt/carpedkm_data/result250115/512x512embedding_refined_oministyle_vaeadd_original_720p_w_timestep"
...
accelerate launch --config_file ../accelerate_config_machine_single_4gpu.yaml --multi_gpu  \
  ...
  --inference \
  --seen_validation \
  --resume_from_checkpoint /mnt/carpedkm_data/result250115/512x512embedding_refined_oministyle_vaeadd_original_720p_w_timestep/checkpoint-6050
  # --subset_cnt 200000 \
  # --inference \
