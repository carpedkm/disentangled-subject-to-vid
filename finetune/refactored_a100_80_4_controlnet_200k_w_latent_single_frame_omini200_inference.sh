...
export DATASET_PATH="/root/daneul/projects/omini200k"
...
export OUTPUT_PATH="/root/daneul/projects/refactored/CogVideo/result_check_200k_512x512_embedding"
...
accelerate launch --config_file accelerate_config_machine_single_4gpu.yaml --multi_gpu \
  ...
  --report_to wandb \
  --inference \
  --resume_from_checkpoint /root/daneul/projects/refactored/CogVideo/result_check_200k_512x512_embedding/checkpoint-1500 
