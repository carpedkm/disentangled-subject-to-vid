...
export DATASET_PATH="/mnt/carpedkm_data/preprocessed_subset100k/background_only_boxes"
export ANNO_PATH="../annotation/video_dict_fullset400k.json"
export OUTPUT_PATH="/mnt/carpedkm_data/finetune_result/241203/finetune100k_one_init_zero_init_clip_t5_fist_no_pe_inf_fix"
...
accelerate launch --config_file accelerate_config_machine_single_8gpu.yaml --multi_gpu \
  ...
  --t5_first \
  --report_to wandb \
  --resume_from_checkpoint /root/mnt/carpedkm_data/finetune_result/241203/finetune100k_one_init_zero_init_clip_t5_fist_no_pe_inf_fix/checkpoint-300 
