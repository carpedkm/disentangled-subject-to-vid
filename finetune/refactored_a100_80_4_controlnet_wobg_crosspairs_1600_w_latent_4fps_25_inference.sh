...
export OUTPUT_PATH="/mnt/carpedkm_data/finetune_result/241223/compare_controlnet_5b_w_latent_4000_xpairs_wobg_4fps_25frames"
export VALIDATION_REF_PATH="./val_samples4/"
...
accelerate launch --config_file accelerate_config_machine_single_4gpu.yaml --multi_gpu \
  train_cogvideox_for_videocustom_wo_vae_241219.py \
  ...
  --wo_bg \
  --use_latent \
  --latent_data_root /mnt/carpedkm_data/pexels_4k_updatd_vae_latents_4fps\
  --report_to wandb \
  --resume_from_checkpoint /mnt/carpedkm_data/finetune_result/241223/compare_controlnet_5b_w_latent_4000_xpairs_wobg_4fps_25frames/checkpoint-1350 \
  --inference
