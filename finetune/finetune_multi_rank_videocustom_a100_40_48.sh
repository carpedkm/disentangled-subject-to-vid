...
export OUTPUT_PATH="/mnt/carpedkm_data/finetune_result/finetune4000_multi_node_a100_40_48"
...
accelerate launch --config_file accelerate_config_machine_multi_48gpu.yaml --multi_gpu --machine_rank ${NODES} \
