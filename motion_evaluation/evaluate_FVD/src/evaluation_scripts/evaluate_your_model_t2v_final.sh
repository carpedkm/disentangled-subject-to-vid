...
Path_to_Benchmark="/mnt/carpedkm_data/image_gen_ds/Pexels_subset_100K_fps8_flow-25-50_sample500"
...
Save_Path="T2V_vanilla_final"

# Loop through dataset sizes
# for TARGET in small; do
video_path_GT="${Path_to_Benchmark}/medium/video_frames"  # Path to real video dataset
video_path_pred="${Path_to_Synthesized_Video}/small/video_frames"  # Path to generated samples
save_path="./Results/${Save_Path}/medium/"  # Path to save results
...
video_path_GT="${Path_to_Benchmark}/small/video_frames"  # Path to real video dataset
video_path_pred="${Path_to_Synthesized_Video}/real_small/video_frames"  # Path to generated samples
save_path="./Results/${Save_Path}/small/"  # Path to save results
...
video_path_GT="${Path_to_Benchmark}/large/video_frames"  # Path to real video dataset
video_path_pred="${Path_to_Synthesized_Video}/real_large/video_frames"  # Path to generated samples
save_path="./Results/${Save_Path}/large/"  # Path to save results
