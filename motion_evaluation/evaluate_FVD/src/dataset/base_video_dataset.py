...
def sample_frames(num_frames, vlen, sample='rand', fix_start=None, fps=None): # TBD, what do you need
...
def read_frames_decord(video_path, num_frames, sample='rand', fix_start=None):
    ...
    frame_idxs = sample_frames(num_frames, vlen, sample=sample, fix_start=fix_start, fps=fps)
