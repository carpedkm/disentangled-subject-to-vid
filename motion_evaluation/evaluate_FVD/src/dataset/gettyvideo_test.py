from getty_dataset import GettyVid
...
vd_info = {
    ...
    "args": {
        "dataset_name": "GettyVid",
        "data_dir": "/home/qid/blob/getty_video/video/videos",
        "metadata_folder_name": "/home/qid/blob/getty_video/video",
        "shuffle": False,
        "num_workers": 16,
        "batch_size": 448,
        "split": "train",
        ...
        "video_params": {
            "input_res": 224,
            "num_frames": 1,  # TBD, if not fix, remove
            "loading": "lax"
        },
