...
def calc_metrics_for_dataset(ctx, metrics, real_data_path, fake_data_path, mirror, resolution, gpus, verbose, use_cache: bool, num_runs: int, run_dir: str, exclude_path=None, real_data_path_additional=None, fake_data_path_additional=None):
    dnnlib.util.Logger(should_flush=True)
    ...
    dummy_dataset_cfg_real = copy.deepcopy(dummy_dataset_cfg)
    dummy_dataset_cfg_fake = copy.deepcopy(dummy_dataset_cfg)
    
    if real_data_path_additional is not None:
        dummy_dataset_cfg_real.data_path_additional = real_data_path_additional
        
    if fake_data_path_additional is not None:
        dummy_dataset_cfg_fake.data_path_additional = fake_data_path_additional
...
@click.option('--real_data_path_additional', default=None, help='Dataset to evaluate metrics against (directory or zip) [default: same as training data]', metavar='PATH')
@click.option('--fake_data_path_additional', default=None, help='Generated images (directory or zip)', metavar='PATH')
