...
def fid50_full(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fid = frechet_inception_distance.compute_fid(opts, max_real=None, num_gen=50)
...
@register_metric
def fvd2048_14f(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fvd = frechet_video_distance.compute_fvd(opts, max_real=2048, num_gen=2048, num_frames=14)
    return dict(fvd2048_14f=fvd)

@register_metric
def fvd4000_14f(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fvd = frechet_video_distance.compute_fvd(opts, max_real=2048, num_gen=4000, num_frames=14)
    return dict(fvd4000_14f=fvd)

@register_metric
def fvd500_49f(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fvd = frechet_video_distance.compute_fvd(opts, max_real=500, num_gen=500, num_frames=49)
    return dict(fvd500_49f=fvd)

@register_metric
def fvd12000_14f(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fvd = frechet_video_distance.compute_fvd(opts, max_real=2048, num_gen=12000, num_frames=14)
    return dict(fvd12000_14f=fvd)


@register_metric
def fvd9_16f(opts):
    opts.dataset_kwargs.update(max_size=None, xflip=False)
    fvd = frechet_video_distance.compute_fvd(opts, max_real=9, num_gen=9, num_frames=16)
    return dict(fvd9_16f=fvd)
